<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%--
	request의 속성에 저장된 person(key)객체(Person타입)을 가져오기
	- id는 속성의 key값
	...
	- property참조방식(OGNL Object Graphical Navigation Language)
	- 필드의 타입이 String/기본형이 아니라면, 표준액션에서 사용시 제약이 있으므로 scriptlet을 이용할 것.
 --%>
 <jsp:useBean id="person" class="com.kh.mvc.person.model.vo.Person" scope="request"></jsp:useBean>
 <jsp:useBean id="sinsa" class="com.kh.mvc.person.model.vo.Person" scope="request"></jsp:useBean>
