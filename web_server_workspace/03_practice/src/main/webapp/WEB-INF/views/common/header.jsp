...
<% if(loginMember == null) { %>
				...
				<form 
					...
					<table>
						<tr>
							<td><input type="text" name="memberId" id="memberId" placeholder="아이디" value="<%= saveMemberId != null ? saveMemberId : "" %>"></td>
...
<% } %>
			...
			<nav>
				<ul class="main-nav">
					...
					<li class="pratice"><a href="<%= request.getContextPath() %>/practice">연습</a></li>
