 ...
 * Generated at: 2021-12-07 13:15:59 UTC
...
public final class boardView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.kh.mvc.board.model.vo.BoardComment");
  }
 ...
 if(loginMember != null && MemberService.ADMIN_ROLE.equals(loginMember.getMemberRole())){ 
	...
	if(commentList != null && !commentList.isEmpty()){
      ...
      out.write("/**\r\n");
      out.write(" * 대댓글 입력\r\n");
      out.write(" * 이벤트발생객체 e.target -> buton.btn-reply\r\n");
      out.write(" */\r\n");
      out.write("$(\".btn-reply\").click((e) => {\r\n");
 if(loginMember == null) { 
      out.write("\r\n");
      ...
      out.write(" \r\n");
      out.write("\r\n");
      out.write("	const commentRef = $(e.target).val();\r\n");
      out.write("	console.log(commentRef);\r\n");
      out.write("\r\n");
      out.write("	const tr = `<tr>\r\n");
      out.write("		<td colspan=\"2\" stlye=\"text-align:left\">\r\n");
      out.write("			<form \r\n");
      out.write("			action=\"");
      out.print( request.getContextPath() );
      out.write("/board/boardCommentEnroll\" \r\n");
      ...
      out.write("			    <input type=\"hidden\" name=\"boardNo\" value=\"\" />\r\n");
      out.write("			    <input type=\"hidden\" name=\"writer\" value=\"\" />\r\n");
      out.write("			    <input type=\"hidden\" name=\"commentLevel\" value=\"2\" />\r\n");
      out.write("			    <input type=\"hidden\" name=\"commentRef\" value=\"${commentRef}\" />    \r\n");
      out.write("				<textarea name=\"content\" cols=\"60\" rows=\"2\"></textarea>\r\n");
      out.write("			    <button type=\"submit\" class=\"btn-comment-enroll2\">등록</button>\r\n");
      out.write("			</form>\r\n");
      out.write("		</td>\r\n");
      out.write("	</tr>`;\r\n");
      out.write("		console.log(tr);\r\n");
      out.write("	\r\n");
      out.write("	// e.target인 버튼태그의 부모tr을 찾고, 다음 형제요소로 추가\r\n");
      out.write("	const $baseTr = $(e.target).parent().parent();\r\n");
      out.write("	\r\n");
      out.write("	$(tr)\r\n");
      out.write("		.insertAfter($baseTr)\r\n");
      out.write("		.find(\"form\")\r\n");
      out.write("		.submit((e) => {\r\n");
      out.write("			const $content = $(\"[name=content]\", e.target);\r\n");
      out.write("			if(!/^(.|\\n)+$/.test($content.val())){\r\n");
      ...
      out.write("		});\r\n");
      out.write("	\r\n");
      out.write("	// 클릭이벤트핸들러 제거!\r\n");
      out.write("	$(e.target).off(\"click\");\r\n");
      out.write("	\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      out.write("$(\"[name=content]\", document.boardCommentFrm).focus((e) => {\r\n");
 if(loginMember == null) { 
      out.write("\r\n");
      out.write("	loginAlert();\r\n");
      out.write("	return;\r\n");
      ...
      out.write("});\r\n");
      out.write("\r\n");
      out.write("$(document.boardCommentFrm).submit((e) => {\r\n");
 if(loginMember == null) { 
      out.write("\r\n");
      out.write("	loginAlert();\r\n");
      out.write("//	e.preventDefault(); // 즉시중지는 아니기 때문에 이벤트의 기본행동만 막을 뿐 아래 코드는 실행된다.\r\n");
      out.write("//	return;\r\n");
      out.write("	return false; // 위에 두개 코드를 합친 효과\r\n");
 } 
      out.write("\r\n");
      out.write("\r\n");
      out.write("	const $content = $(\"[name=content]\", e.target);\r\n");
      ...
      out.write("	if(confirm(\"이 게시물을 정말 삭제하시겠습니까?\")){\r\n");
