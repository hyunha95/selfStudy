 ...
 * Generated at: 2021-11-29 17:29:44 UTC
...
public final class memberEnroll_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1638099922870L));
 ...
 if(loginMember != null && MemberService.ADMIN_ROLE.equals(loginMember.getMemberRole())){ 
      ...
      out.write("	<form name=\"memberEnrollFrm\" action=\"\" method=\"POST\"> <!-- action속성에 값을 적지 않은 이유는 어차피 같은 페이지이기 때문이다. -->\r\n");
      out.write("		<table>\r\n");
      out.write("			<tr>\r\n");
      ...
      out.write("	const name = \"checkIdDuplicatePopup\"; // 팝업페이지 window객체의 name속성\r\n");
      out.write("	const spec = \"left=500px, top=500px, width=300px, height=250px\";\r\n");
      out.write("	const popup = open(\"\", name, spec); // url속성은 작성하지 않는다.\r\n");
      out.write("	\r\n");
      ...
      out.write("\r\n");
      out.write("/**\r\n");
      out.write(" * 중복검사이후 아이디를 변경한 경우, 다시 중복검사해야 한다.\r\n");
      out.write(" */\r\n");
      out.write("$(_memberId).change(() => {\r\n");
