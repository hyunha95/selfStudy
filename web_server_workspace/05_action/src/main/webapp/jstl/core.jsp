...
<body>
	...
	<h2>set | out</h2>
	<ul>
		<li><c:out value="${no1}"></c:out></li>
		<li><c:out value="${no2}"></c:out></li>
		<li><c:out value="${no1 + no2}"></c:out></li>
	...
	<c:if test="${param.x == param.y}">
		${param.x}은 ${param.y}와 같습니다.
	</c:if>
	...
	<!-- begin은 end보다 커야하고 step은 0보다 커야함 -->
		<h${7 - i}>안녕</h${7 - i}>
	</c:forEach>
