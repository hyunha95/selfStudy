...
delete from member where id='practice6';
--commit;

update member 
set password = '$2a$10$ZcGl.OM0VeWw28fpl0DuZ.0.5/lcpIzCDrzYEbKZLLF5hJ1WwFrCa'
where id = 'admin';
commit;
...
insert into memo values(seq_memo_no.nextval, '안녕하세요', '1234', default);
...
insert into
			memo(no, memo, password)
		values(seq_memo_no, memo, password);
