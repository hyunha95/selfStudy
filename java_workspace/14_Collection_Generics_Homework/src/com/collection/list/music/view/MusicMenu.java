...
//				printList(manager.searchMusicByTitle(inputTitle()));
				...
				List<Music> list = manager.searchMusicByTitle(title);
				printList(list);
				break;
			case 7: 
	...
	private void orderMenu() {
		...
		while(true) {
			...
			case 2: printList(manager.orderBy(Collections.reverseOrder())); break;
			case 3: printList(manager.orderBy(new TitleAsc())); break;
			case 4: printList(manager.orderBy(Collections.reverseOrder(new TitleAsc()))); break;
			case 5: return;
			default : System.out.println("잘못 입력하셨습니다.");
			}
		}
